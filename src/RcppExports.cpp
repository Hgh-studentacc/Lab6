...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericVector >::type set_of_weight(set_of_weightSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type set_of_profit(set_of_profitSEXP);
